...
class Shell(Agent):
    ...
    def __init__(self, model, unique_id=None, pos_f: Optional[tuple[float, float]] = None, vx: float = 0.0, vy: float = 0.0):
        """
        Initialize a shell.
        Args:
            model: Model instance.
...
class Target(Agent):
    ...
    def __init__(self, model, unique_id=None, pos_f: Optional[tuple[float, float]] = None):
        """
        Initialize a target.
        Args:
            model: Model instance.
